...
pipeline {
    ...
    environment {
        ...
        DOCKER_IMAGE = 'cithit/abbottrj'                                                 // <------change this
        IMAGE_TAG = "build-${BUILD_NUMBER}"
        GITHUB_URL = 'https://github.com/miamiohAbbottrj/225-lab3-1.git'                   // <------change this
        KUBECONFIG = credentials('abbottrj-225')                                             // <------change this
    }
